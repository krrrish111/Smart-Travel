            ...
            <div class="stories-wrap">
                ...
                <div class="story-item">
                    <div class="story-avatar-ring">
                        <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=100&q=80" alt="Sarah" class="story-avatar-inner">
                    </div>
                    <span class="story-username">Sarah J.</span>
                </div>
                <div class="story-item">
                    <div class="story-avatar-ring">
                        <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=100&q=80" alt="Arjun" class="story-avatar-inner">
                    </div>
                    <span class="story-username">Arjun M.</span>
                </div>
                <div class="story-item">
                    <div class="story-avatar-ring">
                        <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=100&q=80" alt="Priya" class="story-avatar-inner">
                    </div>
                    <span class="story-username">Priya K.</span>
                </div>
                <div class="story-item">
                    <div class="story-avatar-ring seen">
                        <img src="https://images.unsplash.com/photo-1552058544-f2b08422138a?auto=format&fit=crop&w=100&q=80" alt="Rahul" class="story-avatar-inner">
                    </div>
                    <span class="story-username">Rahul S.</span>
                </div>
                <div class="story-item">
                    <div class="story-avatar-ring">
                        <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=100&q=80" alt="Meera" class="story-avatar-inner">
                    </div>
                    <span class="story-username">Meera R.</span>
                </div>
                <div class="story-item">
                    <div class="story-avatar-ring seen">
                        <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=100&q=80" alt="Dev" class="story-avatar-inner">
                    </div>
                    <span class="story-username">Dev P.</span>
                </div>
                <div class="story-item">
                    <div class="story-avatar-ring">
                        <img src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?auto=format&fit=crop&w=100&q=80" alt="Nisha" class="story-avatar-inner">
                    </div>
        ...
        <aside class="community-sidebar">
            ...
            <div class="sidebar-card">
                ...
                <div class="contributor-item">
                    <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=80&q=80" alt="Sarah" class="contributor-avatar">
                ...
                <div class="contributor-item">
                    <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=80&q=80" alt="Priya" class="contributor-avatar">
                    <div class="contributor-info">
                ...
                <div class="contributor-item">
                    <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=80&q=80" alt="Meera" class="contributor-avatar">
                    <div class="contributor-info">
                ...
                <div class="contributor-item">
                    <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=80&q=80" alt="Arjun" class="contributor-avatar">
                    <div class="contributor-info">
                ...
                <div class="contributor-item">
                    <img src="https://images.unsplash.com/photo-1552058544-f2b08422138a?auto=format&fit=crop&w=80&q=80" alt="Rahul" class="contributor-avatar">
                    <div class="contributor-info">
            ...
            <div class="sidebar-card">
                ...
                <div class="trending-dest">
                    ...
                    <img src="https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&w=100&q=80" alt="Rajasthan" class="trending-dest-img">
                ...
                <div class="trending-dest">
                    ...
                    <img src="https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?auto=format&fit=crop&w=100&q=80" alt="Kerala" class="trending-dest-img">
                    <div class="trending-dest-info">
                ...
                <div class="trending-dest">
                    ...
                    <img src="https://images.unsplash.com/photo-1626082896492-766af4eb65ed?auto=format&fit=crop&w=100&q=80" alt="Ladakh" class="trending-dest-img">
                    <div class="trending-dest-info">
                ...
                <div class="trending-dest">
                    ...
                    <img src="https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?auto=format&fit=crop&w=100&q=80" alt="Goa" class="trending-dest-img">
                    <div class="trending-dest-info">
                ...
                <div class="trending-dest">
                    ...
                    <img src="https://images.unsplash.com/photo-1542152019-216e257e84cc?auto=format&fit=crop&w=100&q=80" alt="Coorg" class="trending-dest-img">
                    <div class="trending-dest-info">

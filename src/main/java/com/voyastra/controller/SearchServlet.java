...
public class SearchServlet extends HttpServlet {
    ...
    private void handleFlightSearch(HttpServletRequest request, HttpServletResponse response,
        ...
        // 1. Call Travelpayouts API â†’ parse JSON â†’ List<FlightResult>
        ...
        // 2. Convert FlightResult â†’ Transport (for booking.jsp compatibility)
    ...
    /** Parse "3h 25m" â†’ 205 minutes for duration-based sorting */
    ...
    private Transport buildFlight(String airline, String number, String from, String to,
        ...
        t.setBadge(badge);
        t.setType("flight");
        t.setCompanyLogo(airline.contains("India") ? "âœˆï¸" : "ðŸ›«");
        return t;
    }
    ...
    private List<Transport> getMockCarServices(String pickup, String drop) {
        ...
        sedan.setPrice(1200.0); sedan.setCompanyLogo("ðŸš–"); sedan.setBadge("Sedan");
        list.add(sedan);
        ...
        suv.setPrice(1950.0); suv.setCompanyLogo("ðŸš™"); suv.setBadge("SUV");
        list.add(suv);
        ...
        bus.setPrice(850.0); bus.setCompanyLogo("ðŸšŒ"); bus.setBadge("Sleeper");
        list.add(bus);
        ...
        train.setPrice(2450.0); train.setCompanyLogo("ðŸš†"); train.setBadge("Superfast");
        list.add(train);
    ...
    private List<Transport> getMockCruises(String from, String to, String type) {
        ...
        for(Transport t : list) { t.setType("cruise"); t.setCompanyLogo("ðŸš¢"); }
        return list;
    }
    ...
    private List<Transport> getMockHelicopters(String from, String to, String type) {
        ...
        for(Transport t : list) { t.setType("helicopter"); t.setCompanyLogo("ðŸš"); }
        return list;
    }

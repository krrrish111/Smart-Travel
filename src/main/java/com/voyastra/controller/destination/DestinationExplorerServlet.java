...
import com.voyastra.dao.destination.DestinationInsightDAO;
...
import com.voyastra.service.destination.UnsplashDestinationService;
import com.voyastra.service.YouTubeExplorerService;
import com.voyastra.service.destination.DestinationMapService;
...
public class DestinationExplorerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        request.getRequestDispatcher("/pages/common/experiences.jsp").forward(request, response);

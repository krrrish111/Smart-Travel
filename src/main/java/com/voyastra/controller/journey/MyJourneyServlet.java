...
public class MyJourneyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        com.voyastra.dao.booking.DestinationBookingDAO destBookingDAO = new com.voyastra.dao.booking.DestinationBookingDAO();
        List<com.voyastra.model.booking.DestinationBooking> destBookings = destBookingDAO.getBookingsByUserId(user.getId());

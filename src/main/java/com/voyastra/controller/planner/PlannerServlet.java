...
public class PlannerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("/planner-debug".equals(path)) {
            request.getRequestDispatcher("/pages/planner/planner-debug.jsp").forward(request, response);
            return;
        }
        
        if ("/planner-result".equals(path) || "/planner-result.jsp".equals(path)) {
            request.getRequestDispatcher("/pages/planner/planner-result.jsp").forward(request, response);
            return;
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            java.util.List<com.voyastra.model.destination.Destination> destList = destinationDAO.searchDestinations(destination);
        ...
        try {
            ...
            System.out.println("Forward target = /pages/planner/planner-result.jsp");

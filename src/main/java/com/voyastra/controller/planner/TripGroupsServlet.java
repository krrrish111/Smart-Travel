    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (groupIdStr != null && !groupIdStr.trim().isEmpty()) {
            ...
            try (Connection conn = DBConnection.getConnection()) {
                ...
                request.getRequestDispatcher("/pages/common/group-dashboard.jsp").forward(request, response);
                return;
            ...
            request.getRequestDispatcher("/pages/planner/trip-groups.jsp").forward(request, response);
        }
    }

package com.voyastra.controller.profile;
...
import com.voyastra.dao.planner.ItineraryDAO;
import com.voyastra.model.profile.User;
import com.voyastra.model.booking.Booking;
import com.voyastra.model.planner.Itinerary;
...
public class ProfileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<com.voyastra.model.destination.SavedDestination> savedDestinations = new com.voyastra.dao.destination.SavedDestinationDAO().getSavedDestinationsByUser(userId);
            List<HotelBooking> hotelBookings = hotelBookingDAO.getBookingsByUserId(userId);
            
            // New DAOs for separated bookings
            com.voyastra.dao.booking.FlightBookingDAO flightDAO = new com.voyastra.dao.booking.FlightBookingDAO();
            com.voyastra.dao.booking.CarBookingDAO carDAO = new com.voyastra.dao.booking.CarBookingDAO();
            com.voyastra.dao.booking.TourBookingDAO tourDAO = new com.voyastra.dao.booking.TourBookingDAO();
            com.voyastra.dao.booking.TrainBookingDAO trainDAO = new com.voyastra.dao.booking.TrainBookingDAO();
            com.voyastra.dao.booking.BusBookingDAO busDAO = new com.voyastra.dao.booking.BusBookingDAO();
            com.voyastra.dao.booking.CabBookingDAO cabDAO = new com.voyastra.dao.booking.CabBookingDAO();
            com.voyastra.dao.booking.CruiseBookingDAO cruiseDAO = new com.voyastra.dao.booking.CruiseBookingDAO();
            com.voyastra.dao.booking.HelicopterBookingDAO heliDAO = new com.voyastra.dao.booking.HelicopterBookingDAO();
            
            List<com.voyastra.model.booking.FlightBooking> flightBookings = flightDAO.getBookingsByUserId(userId);
            List<com.voyastra.model.booking.CarBooking> carBookings = carDAO.getBookingsByUserId(userId);
            List<com.voyastra.model.booking.TourBooking> tourBookings = tourDAO.getBookingsByUserId(userId);
            List<com.voyastra.model.booking.TrainBooking> trainBookings = trainDAO.getBookingsByUserId(userId);
            List<com.voyastra.model.booking.BusBooking> busBookings = busDAO.getBookingsByUserId(userId);
            List<com.voyastra.model.booking.CabBooking> cabBookings = cabDAO.getBookingsByUserId(userId);
            List<com.voyastra.model.booking.CruiseBooking> cruiseBookings = cruiseDAO.getBookingsByUserId(userId);
            List<com.voyastra.model.booking.HelicopterBooking> heliBookings = heliDAO.getBookingsByUserId(userId);
            ...
            List<com.voyastra.model.booking.Hotel> wishlistHotels = hotelDAO.getWishlist(userId);
            List<com.voyastra.model.booking.Hotel> recentlyViewedHotels = hotelDAO.getRecentlyViewed(userId);
        ...
        if (bookingIdStr != null) {
            try {
                ...
                if (b != null && b.getUserId() == userId && !"CANCELLED".equals(b.getStatus())) {
                    ...
                    com.voyastra.model.payment.Refund refund = new com.voyastra.model.payment.Refund();
                    ...
                    com.voyastra.dao.payment.RefundDAO refundDAO = new com.voyastra.dao.payment.RefundDAO();
    ...
    private void handleUpdateProfile(HttpServletRequest request, HttpServletResponse response, int userId) throws IOException, ServletException {
        try {
            ...
            if (filePart != null && filePart.getSize() > 0) {
                ...
                String uploadPath = UploadConfig.getProfilesPath(getServletContext());
    ...
    private void handleCancelCarBooking(HttpServletRequest request, HttpServletResponse response, int userId) throws java.io.IOException {
        ...
        if (bookingId != null) {
            new com.voyastra.dao.booking.CarBookingDAO().updateBookingStatus(bookingId, "CANCELLED");
            response.sendRedirect(request.getContextPath() + "/profile?tab=bookings&success=cancelled");
            return;
        }
        response.sendRedirect(request.getContextPath() + "/profile?tab=bookings&error=cancel_failed");
    ...
    private void handleCancelCruiseBooking(HttpServletRequest request, HttpServletResponse response, int userId) throws java.io.IOException {
        String bookingId = request.getParameter("bookingId");
        if (bookingId != null) {
            new com.voyastra.dao.booking.CruiseBookingDAO().updateBookingStatus(bookingId, "CANCELLED");
            response.sendRedirect(request.getContextPath() + "/profile?tab=bookings&success=cancelled");
            return;
        }
        response.sendRedirect(request.getContextPath() + "/profile?tab=bookings&error=cancel_failed");
    ...
    private void handleCancelHelicopterBooking(HttpServletRequest request, HttpServletResponse response, int userId) throws java.io.IOException {
        String bookingId = request.getParameter("bookingId");
        if (bookingId != null) {
            new com.voyastra.dao.booking.HelicopterBookingDAO().updateBookingStatus(bookingId, "CANCELLED");
            response.sendRedirect(request.getContextPath() + "/profile?tab=bookings&success=cancelled");
            return;
        }
        response.sendRedirect(request.getContextPath() + "/profile?tab=bookings&error=cancel_failed");

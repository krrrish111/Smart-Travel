...
@WebServlet("/cruise/ticket")
public class CruiseTicketServlet extends HttpServlet {
    private static final Logger logger = Logger.getLogger(CruiseTicketServlet.class.getName());

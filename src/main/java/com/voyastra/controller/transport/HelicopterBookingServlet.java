...
import com.voyastra.dao.transport.HelicopterDAO;
import com.voyastra.model.booking.HelicopterBooking;
import com.voyastra.model.transport.HelicopterPassenger;
import com.voyastra.model.transport.HelicopterResult;
...
public class HelicopterBookingServlet extends HttpServlet {
    ...
    private void handleReview(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.sendRedirect(request.getContextPath() + "/transport/helicopter/payment");
    }
}

...
@WebServlet({"/transport/helicopter/payment", "/transport/helicopter/payment-callback"})
public class HelicopterPaymentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/pages/transport/helicopter-payment.jsp").forward(request, response);
    }

...
@WebServlet("/train/download-ticket")
public class TrainDownloadTicketServlet extends HttpServlet {
    private static final Logger logger = Logger.getLogger(TrainDownloadTicketServlet.class.getName());

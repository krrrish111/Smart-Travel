...
import com.voyastra.dao.transport.TransportDAO;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if ("add".equals(action)) {
                ...
                AdminLogger.log(request, "ADD", "Transport", 0, "Added " + t.getType() + " '" + t.getCompanyName() + "' (" + t.getOriginCode() + " Ã¢â€ â€™ " + t.getDestinationCode() + ")");

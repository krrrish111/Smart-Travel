...
import com.voyastra.dao.ActivityBookingDAO;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (isValid) {
            try {
                ...
                response.sendRedirect(request.getContextPath() + "/pages/payment.jsp?error=InvalidBooking");
            }
        } else {
            response.sendRedirect(request.getContextPath() + "/pages/payment.jsp?error=PaymentVerificationFailed");
        }
    }
}

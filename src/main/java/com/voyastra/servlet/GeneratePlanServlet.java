...
public class GeneratePlanServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        com.voyastra.util.DiagnosticManager.setStatus(sessionId, com.voyastra.model.PlannerStatus.REQUEST_RECEIVED);

        try {
            com.voyastra.util.DiagnosticManager.setStatus(sessionId, com.voyastra.model.PlannerStatus.VALIDATING_INPUT);
            ...
            if (origin.isEmpty() || destination.isEmpty()) {
                com.voyastra.util.DiagnosticManager.setStatus(sessionId, com.voyastra.model.PlannerStatus.FAILED);
            ...
            com.voyastra.util.DiagnosticManager.setStatus(sessionId, com.voyastra.model.PlannerStatus.GENERATING_ITINERARY);
            ...
            com.voyastra.util.DiagnosticManager.setStatus(sessionId, com.voyastra.model.PlannerStatus.COMPLETED);

...
public class UploadStoryServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Save file
            String uploadPath = getServletContext().getRealPath("") + File.separator + "uploads" + File.separator + "stories";
            ...
            String mediaUrl = request.getContextPath() + "/uploads/stories/" + fileName;

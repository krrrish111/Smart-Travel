...
public class HelicopterBookingServlet extends HttpServlet {
    ...
    private HelicopterBookingDAO dao;

    @Override
    public void init() throws ServletException {
        dao = new HelicopterBookingDAO();
    }

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/pages/transport/helicopter-search.jsp").forward(request, response);
    }

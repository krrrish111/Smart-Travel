...
function renderCommunityPostsTable() {
    ...
    tbody.innerHTML = filtered.map(p => `
        <tr>
            ...
            <td>
                ${p.imageUrl ? `<img src="${p.imageUrl}" style="width:40px; height:40px; border-radius:4px; object-fit:cover;" loading="lazy" decoding="async" referrerpolicy="no-referrer" onerror="vImgErr(this)">` : '<span style="color:#888;font-size:0.7rem;">No Image</span>'}
            </td>

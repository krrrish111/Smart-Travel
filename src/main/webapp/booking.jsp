    ...
    <div class="container flex flex-col lg:flex-row gap-8" style="padding-bottom: 60px;">
        ...
        <div class="results-section">
            <div class="results-header">
                <h2 class="results-title">Transportation Options</h2>
            ...
            <div class="results-grid results-grid-3">
                ...
                <div class="result-card">
                    <div class="result-card-header">
                        <div class="airline-info">
                            ...
                            <div>
                                ...
                                <div class="flight-num">AI-814 · Non-Stop</div>
                            </div>
                        </div>
                        <span class="result-badge fastest">Fastest</span>
                    </div>
                    ...
                    <div class="result-card-footer">
                        <div class="result-price">₹5,400</div>
                ...
                <div class="result-card">
                    <div class="result-card-header">
                        <div class="airline-info">
                            <div class="airline-logo" style="background: var(--color-accent);">VB</div>
                            <div>
                                <div class="airline-name">Vande Bharat Exp</div>
                                <div class="flight-num">22436 · AC Chair Car</div>
                            </div>
                        </div>
                    </div>
                    <div class="flight-times">
                        <div class="time-block">
                            <div class="time">06:00</div>
                            <div class="airport">NDLS</div>
                        </div>
                        <div class="flight-duration">
                            <div class="duration-line"></div>
                            <div class="duration-text">8h 00m</div>
                        </div>
                        <div class="time-block">
                            <div class="time">14:00</div>
                            <div class="airport">BSB</div>
                        </div>
                    </div>
                    <div class="result-card-footer">
                        <div class="result-price">₹1,800</div>
                        <button class="btn-select">Select</button>
                    </div>
                </div>
                ...
                <div class="result-card">
                    <div class="result-card-header">
                        <div class="airline-info">
                            <div class="airline-logo" style="background: #374151; font-size: 1.1rem;">🚖</div>
                            <div>
                                <div class="airline-name">Intercity SUV</div>
                                <div class="flight-num">Innova / Ertiga · 4-6 Seats</div>
                            </div>
                        </div>
                    </div>
                    <div style="text-align: center; padding: 16px 0; border-bottom: 1px solid var(--color-border);">
                        <div class="font-bold text-main" style="font-size: 1rem;">Delhi → Jaipur</div>
                        <div style="font-size: 0.8rem; color: var(--color-muted); margin-top: 4px;">~5 Hrs • 280 km</div>
                    </div>
                    <div class="result-card-footer">
                        <div class="result-price">₹3,200</div>
        ...
        <div class="results-section">
            <div class="results-header">
                <h2 class="results-title">Top Recommended Stays</h2>
                <a href="#" class="results-view-all">View all →</a>
            </div>
            <div class="results-grid results-grid-2">
                ...
                <div class="stay-card result-card" style="display: flex; flex-direction: row; padding: 0; overflow: hidden;">
                    <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=400&h=280&q=80" alt="Hotel" class="stay-card-img">
                    <div class="stay-card-body">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 4px;">
                            <h4 class="stay-name">Taj Lake Palace</h4>
                            <span class="result-badge" style="background: var(--color-primary);">9.6 ★ Excellent</span>
                        </div>
                        <p class="stay-location">📍 Lake Pichola, Udaipur</p>
                        <ul class="stay-amenities">
                            <li>5-Star Heritage Hotel</li>
                            <li>Lake View Rooms</li>
                            <li>Free Cancellation</li>
                        </ul>
                        <div class="stay-footer">
                            <div>
                                <div class="original-price">₹45,000</div>
                                <div class="discounted-price">₹38,000</div>
                                <div style="font-size: 0.72rem; color: var(--color-muted);">+ taxes &amp; fees / night</div>
                            </div>
                ...
                <!-- Airbnb Card -->
                <div class="stay-card result-card" style="display: flex; flex-direction: row; padding: 0; overflow: hidden;">
                    <img src="https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&w=400&h=280&q=80" alt="Villa" class="stay-card-img">
                    <div class="stay-card-body">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 4px;">
                            <h4 class="stay-name">Boho Vintage Villa</h4>
                            <span class="result-badge" style="background: var(--color-accent);">Superhost</span>
                        </div>
                        <p class="stay-location">📍 Assagao, North Goa</p>
                        <ul class="stay-amenities">
                            <li>Entire 3 BHK Villa</li>
                            <li>Private Plunge Pool</li>
                            <li>In-house Chef</li>
                        </ul>
                        <div class="stay-footer">
                            <div>
                                <div class="discounted-price" style="color: var(--color-accent);">₹15,200</div>
                                <div style="font-size: 0.72rem; color: var(--color-muted);">total for 3 nights</div>
                            </div>
                            <button class="btn-book" style="background: var(--color-accent);">Book Villa</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="results-section" style="margin-bottom: 16px;">
            <div class="results-header">
                <h2 class="results-title">Things to Do in Jaipur</h2>
                <a href="#" class="results-view-all">View all →</a>
            </div>
            <div class="results-grid results-grid-4">
                ...
                <div class="activity-card">
                    <div class="activity-img-wrap">
                        <img src="https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&w=400&h=220&q=80" alt="Amber Fort">
                    </div>
                    <div class="activity-info">
                        <h5 class="activity-name">Amber Fort Night Tour</h5>
                        <div class="activity-rating">⭐ 4.8 <span style="color: var(--color-muted); font-weight: 400;">(2.4k reviews)</span></div>
                        <div class="activity-price">₹1,200 <span>/ person</span></div>
                    </div>
                </div>

                <div class="activity-card">
                    <div class="activity-img-wrap">
                        <img src="https://images.unsplash.com/photo-1628126235206-5260b9ea6441?auto=format&fit=crop&w=400&h=220&q=80" alt="Safari">
                    </div>
                    <div class="activity-info">
                        <h5 class="activity-name">Jhalana Leopard Safari</h5>
                        <div class="activity-rating">⭐ 4.9 <span style="color: var(--color-muted); font-weight: 400;">(850 reviews)</span></div>
                        <div class="activity-price">₹2,500 <span>/ person</span></div>
                    </div>
                </div>

                <div class="activity-card">
                    <div class="activity-img-wrap">
                        <img src="https://images.unsplash.com/photo-1561359313-0639aad073f0?auto=format&fit=crop&w=400&h=220&q=80" alt="Food Walk">
                    </div>
                    <div class="activity-info">
                        <h5 class="activity-name">Old City Food Walk</h5>
                        <div class="activity-rating">⭐ 4.7 <span style="color: var(--color-muted); font-weight: 400;">(1.2k reviews)</span></div>
                        <div class="activity-price">₹800 <span>/ person</span></div>
                    </div>
                </div>

                <div class="activity-card">
                    <div class="activity-img-wrap">
                        <img src="https://images.unsplash.com/photo-1517427670530-9db07bb9ebac?auto=format&fit=crop&w=400&h=220&q=80" alt="Balloon">
                    </div>
                    <div class="activity-info">
                        <h5 class="activity-name">Sunrise Hot Air Balloon</h5>
                        <div class="activity-rating">⭐ 4.9 <span style="color: var(--color-muted); font-weight: 400;">(420 reviews)</span></div>
                        <div class="activity-price">₹8,500 <span>/ person</span></div>
                    </div>
                </div>

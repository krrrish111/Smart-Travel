                                                    ...
                                                    <div class="result-card">
                                                        ...
                                                        <div class="result-card-footer">
                                                            ...
                                                            <button class="btn-select"
                                                                onclick="VoyastraAuth.requireAuth('booking', function(){ alert('Selection Captured! Confirming details...'); })">Select</button>
                                                        </div>
                                                    </div>
                                                </c:forEach>
                                            </c:when>
                                                        ...
                                                        <div class="stay-card-body">
                                                            ...
                                                            <div class="stay-footer">
                                                                ...
                                                                <button class="btn-book ${s.type == 'villa' ? 'btn-villa' : ''}"
                                                                    onclick="VoyastraAuth.requireAuth('booking.jsp')">

...
<%
    ...
    // Ensure lists are at least empty for JSTL safety if not set by Servlet
    ...
    <div class="container relative z-10" style="margin-top: -10px;">
        ...
        <div class="flex justify-between items-center mb-10 slide-up" style="flex-wrap: wrap; gap: 16px;">
            ...
            <div style="display:flex; gap: 12px; align-items: center;">
                <a href="edit-profile.jsp" class="btn btn-outline" style="padding: 12px 24px; border-radius: 50px;">Profile</a>
                <a href="logout" class="btn btn-outline" style="padding: 12px 24px; border-radius: 50px; background: rgba(239,68,68,0.1); border-color: rgba(239,68,68,0.3); color: #fca5a5;">
                    Sign Out
                </a>
            </div>
        </div>

    ...
    <%@ include file="components/global_ui.jsp" %>
        ...
        <main style="padding-top: 120px; overflow-x: hidden;">
            ...
            <section class="container relative parallax-wrapper" style="margin-bottom: 80px;">
                <div class="grid grid-cols-2 items-center gap-4 h-full" style="min-height: 80vh;">

                    <!-- Hero Content -->
                    <div class="hero-content parallax-bg" style="position: relative; z-index: 10;" data-speed="0.05">
                        <div class="mb-3 inline-block"
                            style="padding: 6px 16px; background: var(--color-surface); border-radius: 30px; border: 1px solid var(--color-border);">
                            <span class="text-primary font-bold text-sm"
                                style="font-family: 'DM Sans', sans-serif; color: var(--color-accent);">✨ The Future of
                                Travel</span>
                        </div>
                        ...
                        <p class="mb-4"
                            style="color: var(--text-on-img); font-size: 1.25rem; text-shadow: 0 2px 15px rgba(0,0,0,0.7); opacity: 0.95;">
                        ...
                        <div class="flex gap-3 items-center mb-5">
                            <a href="planner.jsp" class="btn btn-primary tilt-card"
                    ...
                    <!-- Hero Visuals (Parallax Floating Cards) -->
                    <div class="hero-visual relative flex justify-center items-center parallax-bg"
                        style="perspective: 1200px; height: 100%; min-height: 500px;" data-speed="-0.08">

                        <!-- Main Center Card -->
                        <div class="glass-panel tilt-card"
                            style="width: 340px; padding: 20px; z-index: 2; transform: rotateY(-10deg) rotateX(5deg);">
                            <div class="tilt-content">
                                <img src="https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&w=600&q=80"
                                    alt="Taj Mahal" class="w-full rounded-lg mb-3"
                                    style="height: 220px; object-fit: cover; box-shadow: var(--shadow-md);">
                                <h3 class="editorial mb-1 text-main" style="font-size: 1.75rem;">Agra, Uttar Pradesh
                                </h3>
                                <div class="flex justify-between items-center bg-white"
                                    style="padding: 12px 16px; border-radius: 12px; background: rgba(255,255,255,0.7); backdrop-filter: blur(8px);">
                                    <span class="font-bold text-primary"
                                        style="font-size: 1.25rem; font-family: 'DM Sans', sans-serif;">₹12,000</span>
                                    <span class="text-muted text-sm font-semibold"
                                        style="font-family: 'DM Sans', sans-serif;">3 Days</span>
                                </div>
                            </div>
                        </div>

                        <!-- Floating Badge -->
                        <div class="glass-panel absolute tilt-card"
                            style="width: 260px; padding: 20px; bottom: 5%; left: -10%; z-index: 3; box-shadow: var(--shadow-lg);">
                            <div class="tilt-content">
                                <div class="flex justify-between items-center mb-3">
                                    ...
                                    <span class="relative flex h-3 w-3">
                                        <span
                                            ...
                                            style="background:var(--color-accent);animation: pulse 1.5s cubic-bezier(0.4, 0, 0.6, 1) infinite;"></span>
                                        <span class="relative inline-flex rounded-full h-3 w-3"
                                            style="background:var(--color-accent);"></span>
                                    </span>
                                </div>
                                <div class="text-muted mb-2"
                                    style="font-size: 0.9rem; font-family: 'DM Sans', sans-serif;">Building optimal
                                    route...</div>
                                <div class="progress-container" style="height: 8px;">
                                    <div class="progress-bar"
                                        style="width: 82%; background: linear-gradient(90deg, var(--color-accent), var(--color-primary));">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- ====== PLAN CARDS AUTO-SCROLL ====== -->
            <section class="carousel-section container scroll-fade">
                ...
                <!-- Outer: overflow hidden + fade mask -->
                <div class="plan-scroll-outer">
                    <!-- Inner: two copies of cards for seamless infinite loop -->
                    <div class="plan-scroll-inner" id="planScrollInner">
                        ...
                        <div class="plan-card active">
                            <div class="plan-card-img-wrap">
                                <img src="https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&w=800&q=80"
                                    alt="Rajasthan">
                                <div class="plan-card-category" style="background:rgba(245,158,11,0.85);">Heritage</div>
                            </div>
                            <div class="plan-card-body">
                                <div class="plan-card-location"><svg width="12" height="12" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                                        <circle cx="12" cy="10" r="3"></circle>
                                    </svg> Rajasthan, India</div>
                                <div class="plan-card-title">Royal Desert Escape</div>
                                <div class="plan-tags">
                                    <span class="plan-tag"
                                        style="background:rgba(212,168,106,0.1);color:var(--color-accent);">Desert
                                        Safari</span>
                                    <span class="plan-tag"
                                        style="background:rgba(212,168,106,0.07);color:var(--color-primary);">Fort
                                        Hopping</span>
                                    <span class="plan-tag"
                                        style="background:rgba(212,168,106,0.05);color:var(--color-muted);">Cultural</span>
                                </div>
                                <div class="plan-itinerary">
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 1</span> Arrive
                                        Jaipur — Amber Fort &amp; City Palace tour.</div>
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 2</span> Drive to
                                        Jodhpur — Blue City walk &amp; Mehrangarh.</div>
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 3</span> Jaisalmer
                                        — Golden Fort &amp; sunset camel safari.</div>
                                </div>
                                ...
                                <a href="planner.jsp" class="plan-card-view-btn">View Plan →</a>
                            </div>
                        </div>
                        ...
                        <div class="plan-card">
                            <div class="plan-card-img-wrap">
                                <img src="https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?auto=format&fit=crop&w=800&q=80"
                                    alt="Kerala">
                                <div class="plan-card-category" style="background:rgba(16,185,129,0.85);">Nature</div>
                            </div>
                            <div class="plan-card-body">
                                <div class="plan-card-location"><svg width="12" height="12" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                                        <circle cx="12" cy="10" r="3"></circle>
                                    </svg> Kerala, India</div>
                                <div class="plan-card-title">Backwaters &amp; Spice Hills</div>
                                <div class="plan-tags">
                                    <span class="plan-tag"
                                        style="background:rgba(150,201,141,0.1);color:var(--color-primary);">Houseboat</span>
                                    <span class="plan-tag"
                                        style="background:rgba(150,201,141,0.07);color:var(--color-accent);">Tea
                                        Estates</span>
                                    <span class="plan-tag"
                                        style="background:rgba(150,201,141,0.05);color:var(--color-muted);">Ayurveda</span>
                                </div>
                                <div class="plan-itinerary">
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 1</span> Arrive
                                        Kochi — Fort Kochi &amp; spice market walk.</div>
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 2</span> Alleppey —
                                        overnight houseboat on the backwaters.</div>
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 3</span> Munnar —
                                        rolling tea estates &amp; viewpoint trek.</div>
                                </div>
                                <div class="plan-card-footer">
                        ...
                        <div class="plan-card">
                            <div class="plan-card-img-wrap">
                                <img src="https://images.unsplash.com/photo-1626082896492-766af4eb65ed?auto=format&fit=crop&w=800&q=80"
                                    alt="Ladakh">
                                <div class="plan-card-category" style="background:rgba(90,108,145,0.85);">Adventure
                                </div>
                            </div>
                            <div class="plan-card-body">
                                <div class="plan-card-location"><svg width="12" height="12" viewBox="0 0 24 24"
                                        ...
                                        <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                                        <circle cx="12" cy="10" r="3"></circle>
                                    </svg> Ladakh, J&amp;K, India</div>
                                <div class="plan-card-title">High-Altitude Odyssey</div>
                                <div class="plan-tags">
                                    <span class="plan-tag"
                                        style="background:rgba(154,184,212,0.1);color:var(--color-primary);">Pangong
                                        Lake</span>
                                    <span class="plan-tag"
                                        style="background:rgba(154,184,212,0.07);color:var(--color-accent);">Monasteries</span>
                                    <span class="plan-tag"
                                        style="background:rgba(154,184,212,0.05);color:var(--color-muted);">Offroad</span>
                                </div>
                                <div class="plan-itinerary">
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 1</span> Arrive Leh
                                        — acclimatize, Shanti Stupa sunset.</div>
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 2</span> Khardung
                                        La Pass — world's highest motorable road.</div>
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 3</span> Pangong
                                        Lake — camp under a star-lit sky.</div>
                                </div>
                                <div class="plan-card-footer">
                        ...
                        <div class="plan-card">
                            <div class="plan-card-img-wrap">
                                <img src="https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?auto=format&fit=crop&w=800&q=80"
                                    alt="Goa">
                                <div class="plan-card-category" style="background:rgba(75,120,148,0.85);">Beach</div>
                            </div>
                            <div class="plan-card-body">
                                <div class="plan-card-location"><svg width="12" height="12" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2">
                                ...
                                <div class="plan-card-title">Sun, Shacks &amp; Sunsets</div>
                                <div class="plan-tags">
                                    <span class="plan-tag"
                                        style="background:rgba(107,154,184,0.1);color:var(--color-primary);">North
                                        Goa</span>
                                    <span class="plan-tag"
                                        style="background:rgba(107,154,184,0.07);color:var(--color-accent);">Old
                                        Churches</span>
                                    <span class="plan-tag"
                                        style="background:rgba(107,154,184,0.05);color:var(--color-muted);">Nightlife</span>
                                </div>
                                <div class="plan-itinerary">
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 1</span> North Goa
                                        — Baga beach, shacks &amp; water sports.</div>
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 2</span> Old Goa —
                                        Basilica Bom Jesus &amp; spice plantation.</div>
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 3</span> South Goa
                                        — Palolem beach, kayaking &amp; seafood.</div>
                                </div>
                                <div class="plan-card-footer">
                        ...
                        <div class="plan-card">
                            <div class="plan-card-img-wrap">
                                <img src="https://images.unsplash.com/photo-1561359313-0639aad073f0?auto=format&fit=crop&w=800&q=80"
                                    alt="Varanasi">
                                <div class="plan-card-category" style="background:rgba(239,68,68,0.85);">Spiritual</div>
                            </div>
                            <div class="plan-card-body">
                                <div class="plan-card-location"><svg width="12" height="12" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                                        <circle cx="12" cy="10" r="3"></circle>
                                    </svg> Varanasi, Uttar Pradesh</div>
                                <div class="plan-card-title">Sacred Ganges Journey</div>
                                <div class="plan-tags">
                                    <span class="plan-tag"
                                        style="background:rgba(212,140,90,0.1);color:var(--color-primary);">Ghat
                                        Walk</span>
                                    <span class="plan-tag"
                                        style="background:rgba(212,140,90,0.07);color:var(--color-accent);">Aarti
                                        Ceremony</span>
                                    <span class="plan-tag"
                                        style="background:rgba(212,140,90,0.05);color:var(--color-muted);">Silk
                                        Weaving</span>
                                </div>
                                <div class="plan-itinerary">
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 1</span>
                                        Dasaswamedh Ghat — evening Ganga Aarti ceremony.</div>
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 2</span> Dawn boat
                                        ride on the Ganges — Manikarnika Ghat.</div>
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 3</span> Sarnath —
                                        Buddhist ruins &amp; local silk market.</div>
                                </div>
                                <div class="plan-card-footer">
                                    <div class="plan-price">₹10,500</div>
                                    <div class="plan-duration"><svg width="12" height="12" viewBox="0 0 24 24"
                                            fill="none" stroke="currentColor" stroke-width="2">
                                            <circle cx="12" cy="12" r="10"></circle>
                                            <polyline points="12 6 12 12 16 14"></polyline>
                        ...
                        <div class="plan-card">
                            <div class="plan-card-img-wrap">
                                <img src="https://images.unsplash.com/photo-1542152019-216e257e84cc?auto=format&fit=crop&w=800&q=80"
                                    alt="Coorg">
                                <div class="plan-card-category" style="background:rgba(16,185,129,0.85);">Wellness</div>
                            </div>
                            <div class="plan-card-body">
                                <div class="plan-card-location"><svg width="12" height="12" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                                        <circle cx="12" cy="10" r="3"></circle>
                                    </svg> Coorg, Karnataka</div>
                                <div class="plan-card-title">Coffee Estate Retreat</div>
                                <div class="plan-tags">
                                    <span class="plan-tag"
                                        style="background:rgba(150,184,145,0.1);color:var(--color-primary);">Coffee
                                        Trails</span>
                                    <span class="plan-tag"
                                        style="background:rgba(150,184,145,0.07);color:var(--color-accent);">Waterfalls</span>
                                    <span class="plan-tag"
                                        style="background:rgba(150,184,145,0.05);color:var(--color-muted);">Treehouse</span>
                                </div>
                                <div class="plan-itinerary">
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 1</span> Arrive
                                        Madikeri — coffee plantation walk &amp; homestay.</div>
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 2</span> Abbey
                                        Falls trek &amp; Raja's Seat sunset view.</div>
                                    <div class="plan-itinerary-step"><span class="plan-step-day">Day 3</span> Namdroling
                                        Monastery &amp; local Coorg cuisine.</div>
                                </div>
                                <div class="plan-card-footer">
                    ...
                    </div><!-- /plan-scroll-inner -->
                </div><!-- /plan-scroll-outer -->
            </section>
            ...
            <section class="section scroll-fade relative dest-carousel-section" style="background: var(--color-surface); padding-top: 80px; padding-bottom: 80px;">
                ...
                <div class="dest-carousel-wrap" id="destCarouselWrap">
                    ...
                    <div class="dest-carousel-viewport" id="destViewport">
                        <div class="dest-carousel-track" id="destTrack">
                            ...
                            <!-- Card 1: Munnar -->
                            <div class="dest-card" data-index="0">
                                <img src="https://images.unsplash.com/photo-1593693397690-362cb9666fc2?auto=format&fit=crop&w=800&q=80" alt="Munnar">
                                <div class="dest-card-overlay"></div>
                                <div class="dest-card-rank">#1 Trending</div>
                                <div class="dest-card-category" style="background: rgba(16,185,129,0.85);">Nature</div>
                                <div class="dest-card-content">
                                    <div class="dest-card-name">Munnar</div>
                                    <div class="dest-card-sub">Kerala · Tea Estates & Misty Hills</div>
                                    <div class="dest-card-meta">
                                        <div class="dest-card-price">₹18,000</div>
                                        <div class="dest-card-duration">
                                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                                            4 Days
                                        </div>
                                        <div class="dest-card-rating">★ 4.9</div>
                                    </div>
                                </div>
                            </div>

                            <!-- Card 2: Rishikesh -->
                            <div class="dest-card" data-index="1">
                                <img src="https://images.unsplash.com/photo-1517427670530-9db07bb9ebac?auto=format&fit=crop&w=800&q=80" alt="Rishikesh">
                                <div class="dest-card-overlay"></div>
                                <div class="dest-card-rank">#2 Trending</div>
                                <div class="dest-card-category" style="background: rgba(59,130,246,0.85);">Adventure</div>
                                <div class="dest-card-content">
                                    <div class="dest-card-name">Rishikesh</div>
                                    <div class="dest-card-sub">Uttarakhand · Yoga Capital & Rafting</div>
                                    <div class="dest-card-meta">
                                        <div class="dest-card-price">₹12,500</div>
                                        <div class="dest-card-duration">
                                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                                            3 Days
                                        </div>
                                        <div class="dest-card-rating">★ 4.8</div>
                                    </div>
                                </div>
                            </div>

                            <!-- Card 3: South Goa -->
                            <div class="dest-card" data-index="2">
                                <img src="https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&w=800&q=80" alt="Goa">
                                <div class="dest-card-overlay"></div>
                                <div class="dest-card-rank">#3 Trending</div>
                                <div class="dest-card-category" style="background: rgba(75,120,148,0.85);">Beach</div>
                                <div class="dest-card-content">
                                    <div class="dest-card-name">South Goa</div>
                                    <div class="dest-card-sub">Goa · Pristine Beaches & Villas</div>
                                    <div class="dest-card-meta">
                                        <div class="dest-card-price">₹14,000</div>
                                        <div class="dest-card-duration">
                                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                                            4 Days
                                        </div>
                            ...
                            <!-- Card 4: Leh Ladakh -->
                            <div class="dest-card" data-index="3">
                                <img src="https://images.unsplash.com/photo-1626082896492-766af4eb65ed?auto=format&fit=crop&w=800&q=80" alt="Leh Ladakh">
                                <div class="dest-card-overlay"></div>
                                <div class="dest-card-rank">#4 Trending</div>
                                <div class="dest-card-category" style="background: rgba(90,108,145,0.85);">Altitude</div>
                                <div class="dest-card-content">
                                    <div class="dest-card-name">Leh Ladakh</div>
                                    <div class="dest-card-sub">J&K · Monasteries & High Passes</div>
                                    <div class="dest-card-meta">
                                        <div class="dest-card-price">₹35,000</div>
                                        <div class="dest-card-duration">
                                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                                            8 Days
                                        </div>
                            ...
                            <!-- Card 5: Jaipur -->
                            <div class="dest-card" data-index="4">
                                <img src="https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&w=800&q=80" alt="Jaipur">
                                <div class="dest-card-overlay"></div>
                                <div class="dest-card-rank">#5 Trending</div>
                                <div class="dest-card-category" style="background: rgba(245,158,11,0.85);">Heritage</div>
                                <div class="dest-card-content">
                                    <div class="dest-card-name">Jaipur</div>
                                    <div class="dest-card-sub">Rajasthan · Pink City & Royal Forts</div>
                                    <div class="dest-card-meta">
                                        <div class="dest-card-price">₹22,500</div>
                                        <div class="dest-card-duration">
                                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                                            5 Days
                                        </div>
                                        <div class="dest-card-rating">★ 4.7</div>
                                    </div>
                                </div>
                            </div>

                            <!-- Card 6: Varanasi -->
                            <div class="dest-card" data-index="5">
                                <img src="https://images.unsplash.com/photo-1561359313-0639aad073f0?auto=format&fit=crop&w=800&q=80" alt="Varanasi">
                                <div class="dest-card-overlay"></div>
                                <div class="dest-card-rank">#6 Trending</div>
                                <div class="dest-card-category" style="background: rgba(239,68,68,0.85);">Spiritual</div>
                                <div class="dest-card-content">
                                    <div class="dest-card-name">Varanasi</div>
                                    <div class="dest-card-sub">Uttar Pradesh · Ganges & Aarti</div>
                                    <div class="dest-card-meta">
                                        <div class="dest-card-price">₹10,500</div>
                                        <div class="dest-card-duration">
                                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                                            3 Days
                                        </div>
                            ...
                            <!-- Card 7: Kerala Backwaters -->
                            <div class="dest-card" data-index="6">
                                <img src="https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?auto=format&fit=crop&w=800&q=80" alt="Kerala">
                                <div class="dest-card-overlay"></div>
                                <div class="dest-card-rank">#7 Trending</div>
                                <div class="dest-card-category" style="background: rgba(16,185,129,0.85);">Nature</div>
                                <div class="dest-card-content">
                                    <div class="dest-card-name">Kerala Backwaters</div>
                                    <div class="dest-card-sub">Kerala · Houseboats & Spice Hills</div>
                                    <div class="dest-card-meta">
                                        <div class="dest-card-price">₹18,000</div>
                                        <div class="dest-card-duration">
                                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                            ...
                            <!-- Card 8: Coorg -->
                            <div class="dest-card" data-index="7">
                                <img src="https://images.unsplash.com/photo-1542152019-216e257e84cc?auto=format&fit=crop&w=800&q=80" alt="Coorg">
                                <div class="dest-card-overlay"></div>
                                <div class="dest-card-rank">#8 Trending</div>
                                <div class="dest-card-category" style="background: rgba(16,185,129,0.75);">Wellness</div>
                                <div class="dest-card-content">
                                    <div class="dest-card-name">Coorg</div>
                                    <div class="dest-card-sub">Karnataka · Coffee Trails & Waterfalls</div>
                                    <div class="dest-card-meta">
                                        <div class="dest-card-price">₹16,000</div>
                                        <div class="dest-card-duration">
                                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                                            4 Days
                                        </div>
                ...
                (function () {
                    ...
                    /* ── Translate to position (logical index) ── */
                    ...
                    /* ── Infinite-loop bounce fix after transition ends ── */
            ...
            <section class="section scroll-fade relative" style="padding-top: 80px;">
                ...
                <div class="plan-scroll-outer">
                    <div class="plan-scroll-inner" style="animation-duration: 45s;">
                        <!-- Activity 1 -->
            ...
            <section class="section scroll-fade relative" id="destinations">
                ...
                <div class="dest-grid hover-triggers">

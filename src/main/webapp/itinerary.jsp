    ...
    <div class="grid grid-cols-3 gap-4">
        ...
        <div class="slide-up delay-2">
            <div class="glass-panel" style="padding: 24px; position: sticky; top: 100px;">
                <h3 class="mb-3 text-main" style="font-size: 1.25rem;">Budget Breakdown</h3>
                
                <div class="flex justify-between items-center mb-3 pb-3" style="border-bottom: 1px dashed rgba(0,0,0,0.1);">
                    <span class="text-muted text-sm flex gap-2 items-center"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg> Accommodation</span>
                    <span class="font-bold">₹15,000</span>
                </div>
                
                <div class="flex justify-between items-center mb-3 pb-3" style="border-bottom: 1px dashed rgba(0,0,0,0.1);">
                    <span class="text-muted text-sm flex gap-2 items-center"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg> Activities</span>
                    <span class="font-bold">₹8,000</span>
                </div>
                
                <div class="flex justify-between items-center mb-3 pb-3" style="border-bottom: 1px dashed rgba(0,0,0,0.1);">
                    <span class="text-muted text-sm flex gap-2 items-center"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg> Food</span>
                    <span class="font-bold">₹12,000</span>
                </div>
                
                <div class="flex justify-between items-center mb-4 pb-3" style="border-bottom: 1px dashed rgba(0,0,0,0.1);">
                    <span class="text-muted text-sm flex gap-2 items-center"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> Transport</span>
                    <span class="font-bold">₹10,000</span>
                </div>

                <div class="flex justify-between items-center mb-4">
                    <span class="font-bold text-main" style="font-size: 1.1rem;">Total Est. Cost</span>
                    <span class="font-bold text-primary" style="font-size: 1.4rem;">₹45,000</span>
                </div>

                <a href="booking.jsp" class="btn btn-primary w-full" style="justify-content: center;">Proceed to Booking</a>
            </div>
        </div>

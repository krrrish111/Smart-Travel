...
<div class="details-container">
    <div class="details-header">
        ...
        <h1 class="details-title">Flight Booking Details</h1>
    ...
    <div class="details-grid">
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">${booking.flightNum}</div>
        </div>
        <div class="detail-item">
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">${booking.departureDate}</div>
        </div>
        <div class="detail-item">
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">${booking.gate}</div>
        </div>
        <div class="detail-item">
            <div class="detail-label">Class</div>
            <div class="detail-value">${booking.seatClass}</div>
        </div>
        <div class="detail-item">

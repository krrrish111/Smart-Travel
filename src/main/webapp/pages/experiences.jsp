                ...
                `;
                                    ...
                                    document.addEventListener('DOMContentLoaded', function () {
                                        ...
                                        try {
                                            ...
                                            if (_mapJson) mapMarkersData = JSON.parse(_mapJson.textContent);
                                        ...
                                        try {
                                            ...
                                            if (_tipsJson) travelTipsData = JSON.parse(_tipsJson.textContent);
                                        ...
                                        try {
                                            ...
                                            if (_itinJson) itineraryPreviewsData = JSON.parse(_itinJson.textContent);
                                        ...
                                        try {
                                            ...
                                            if (_cartJson) initialCart = JSON.parse(_cartJson.textContent) || [];

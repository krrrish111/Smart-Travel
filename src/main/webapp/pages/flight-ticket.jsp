    ...
    <div class="ticket-container" id="ticketArea">
        ...
        <div class="content-grid">
            ...
            <div class="field-group">
                ...
                <div class="value">${booking.flightNum}</div>
            </div>
            <div class="field-group">
                <div class="label">Route</div>
                <div class="value">${booking.origin} to ${booking.destination}</div>
            </div>
            <div class="field-group">
            ...
            <div class="field-group">
                ...
                <div class="value">${booking.seatNumber} | ${booking.seatClass}</div>
            </div>
            <div class="field-group">

            ...
            <div class="container mx-auto px-4 pt-24 pb-12">
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="bg-black border border-white/10 rounded p-6">
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center text-xs"
                                    ...
                                    <div class="p-2 border border-white/5 rounded text-gray-500">1 Input Validation
                                    </div>
                                    <div class="p-2 border border-white/5 rounded text-gray-500">2 Destination
                                        Processing</div>
                                    <div class="p-2 border border-white/5 rounded text-gray-500">3 Budget Calculation
                                    </div>
                                    ...
                                    <div class="p-2 border border-white/5 rounded text-gray-500">6 Recommendation
                                        Generation</div>
                            ...
                            <div id="debugDuplicateWarning"
                                class="hidden bg-red-900/50 border border-red-500 rounded p-4 text-red-200">
                                <h3 class="font-bold mb-2 flex items-center gap-2"><i class="ri-alert-line text-xl"></i>
                                    ⚠ Duplicate Content Detected</h3>
                ...
                <script>
                    ...
                    function renderDashboard(data) {
                        ...
                        if (badge && data.diagnosticStatus) {
                            badge.innerText = data.diagnosticStatus;
                            ...
                            } else if (data.diagnosticStatus === 'FAILED') {
                        ...
                        const getCardState = (key) => {
                            ...
                            if (data.logs.some(l => l.operation.includes(key) && l.status === 'NOT USED')) return { color: 'text-gray-400', bg: 'bg-white/5', border: 'border-white/10', icon: 'ri-skip-forward-line', text: 'NOT USED' };
                ...
                `;
                        ...
                        if (data.logs.length > 0 && traces && traces.length >= 8) {
                            ...
                            const hasLogSuccess = (op) => data.logs.some(l => l.operation === op && l.status === 'SUCCESS');
                            
                            traces[0].className = hasLogSuccess('Input Validation') ? activeClass : inactiveClass;
                            traces[1].className = hasLogSuccess('Destination') ? activeClass : inactiveClass;
                            traces[2].className = hasLogSuccess('Budget Engine') ? activeClass : inactiveClass;
                            traces[3].className = hasLogSuccess('Unsplash API') ? activeClass : inactiveClass;
                            traces[4].className = hasLogSuccess('YouTube API') ? activeClass : inactiveClass;
                            traces[5].className = (hasLogSuccess('Gemini API') || (globalAiJson && globalAiJson.title)) ? activeClass : inactiveClass;
                            traces[6].className = hasLogSuccess('Itinerary Engine') ? activeClass : inactiveClass;
                            traces[7].className = hasLogSuccess('Result Page Forward') ? activeClass : inactiveClass;
                        }
                    }

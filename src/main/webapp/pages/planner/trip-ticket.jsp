            ...
            <div class="field-group" style="grid-column: span 2; display: flex; justify-content: center; margin-top: 20px;">
                <div style="text-align: center;">
                    ...
                    <div class="value" style="margin-top: 10px;">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=Voyastra_Trip_${param.bookingId}" alt="QR Code" style="border-radius: 8px; border: 1px solid #ccc; padding: 10px;" loading="lazy" decoding="async" referrerpolicy="no-referrer" onerror="vImgErr(this)">
                    </div>
                </div>
            </div>
        </div>

...
<div class="dashboard-container">
    ...
    <main class="dashboard-main">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-value" style="color:var(--color-primary);">â‚¹${user.walletBalance}</div>
        ...
        <section id="bookings" class="content-section ${activeTab == 'bookings' ? 'active' : ''}">
            ...
            <div id="all-bookings-container">
                ...
                <div class="booking-category" id="cat-flights">
                    <h3 style="margin-bottom: 15px; color: var(--text-primary);">âœˆ Flights</h3>
                    <div class="booking-list">
                        <c:choose>
                                    ...
                                    <div class="booking-item booking-card-status" data-status="${f.status.toLowerCase()}">
                                        ...
                                        <div style="text-align: right; display:flex; flex-direction:column; gap:8px;">
                                            <div>
                                                ...
                                                <span style="font-weight: 800; font-size: 1.2rem; color:var(--color-primary);">â‚¹${f.totalPrice}</span>
                                            </div>
                            ...
                            <c:otherwise>
                                <div class="empty-state" style="padding: 30px; text-align: center; border: 1px dashed var(--color-border); border-radius: 12px;">
                                    <p style="color: var(--text-secondary); font-size: 1.1rem;">âœˆ No flight bookings found</p>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
                ...
                <div class="booking-category" id="cat-hotels" style="margin-top: 40px;">
                    <h3 style="margin-bottom: 15px; color: var(--text-primary);">ðŸ¨ Hotels</h3>
                    <div class="booking-list">
                        <c:choose>
                                    ...
                                    <div class="booking-item booking-card-status" data-status="${h.status.toLowerCase()}">
                                        ...
                                        <div style="text-align: right; display:flex; flex-direction:column; gap:8px;">
                                            <div>
                                                ...
                                                <span style="font-weight: 800; font-size: 1.2rem; color:var(--color-primary);">â‚¹${h.totalPrice}</span>
                                            </div>
                                            <div style="display:flex; gap:5px; justify-content: flex-end; margin-top:10px;">
                            ...
                            <c:otherwise>
                                <div class="empty-state" style="padding: 30px; text-align: center; border: 1px dashed var(--color-border); border-radius: 12px;">
                                    <p style="color: var(--text-secondary); font-size: 1.1rem;">ðŸ¨ No hotel bookings found</p>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
                ...
                <div class="booking-category" id="cat-trains" style="margin-top: 40px;">
                    <h3 style="margin-bottom: 15px; color: var(--text-primary);">ðŸš† Trains</h3>
                    <div class="booking-list">
                        <c:choose>
                                    ...
                                    <div class="booking-item booking-card-status" data-status="${t.status.toLowerCase()}">
                                        ...
                                        <div style="text-align: right; display:flex; flex-direction:column; gap:8px;">
                                            <div>
                                                ...
                                                <span style="font-weight: 800; font-size: 1.2rem; color:var(--color-primary);">â‚¹${t.totalFare}</span>
                                            </div>
                                                                                        <div style="display:flex; gap:5px; justify-content: flex-end; margin-top:10px;">
                            ...
                            <c:otherwise>
                                <div class="empty-state" style="padding: 30px; text-align: center; border: 1px dashed var(--color-border); border-radius: 12px;">
                                    <p style="color: var(--text-secondary); font-size: 1.1rem;">ðŸš† No train bookings found</p>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
                ...
                <div class="booking-category" id="cat-buses" style="margin-top: 40px;">
                    <h3 style="margin-bottom: 15px; color: var(--text-primary);">ðŸšŒ Buses</h3>
                    <div class="booking-list">
                        <c:choose>
                                    ...
                                    <div class="booking-item booking-card-status" data-status="${b.status.toLowerCase()}">
                                        ...
                                        <div style="text-align: right; display:flex; flex-direction:column; gap:8px;">
                                            <div>
                                                ...
                                                <span style="font-weight: 800; font-size: 1.2rem; color:var(--color-primary);">â‚¹${b.totalFare}</span>
                                            </div>
                                                                                        <div style="display:flex; gap:5px; justify-content: flex-end; margin-top:10px;">
                            ...
                            <c:otherwise>
                                <div class="empty-state" style="padding: 30px; text-align: center; border: 1px dashed var(--color-border); border-radius: 12px;">
                                    <p style="color: var(--text-secondary); font-size: 1.1rem;">ðŸšŒ No bus bookings found</p>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
                ...
                <div class="booking-category" id="cat-cabs" style="margin-top: 40px;">
                    <h3 style="margin-bottom: 15px; color: var(--text-primary);">ðŸš• Cabs</h3>
                    <div class="booking-list">
                        <c:choose>
                                    ...
                                    <div class="booking-item booking-card-status" data-status="${c.status.toLowerCase()}">
                                        ...
                                        <div style="text-align: right; display:flex; flex-direction:column; gap:8px;">
                                            <div>
                                                ...
                                                <span style="font-weight: 800; font-size: 1.2rem; color:var(--color-primary);">â‚¹${c.totalFare}</span>
                                            </div>
                                                                                        <div style="display:flex; gap:5px; justify-content: flex-end; margin-top:10px;">
                            ...
                            <c:otherwise>
                                <div class="empty-state" style="padding: 30px; text-align: center; border: 1px dashed var(--color-border); border-radius: 12px;">
                                    <p style="color: var(--text-secondary); font-size: 1.1rem;">ðŸš• No cab bookings found</p>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
                ...
                <div class="booking-category" id="cat-cars" style="margin-top: 40px;">
                    <h3 style="margin-bottom: 15px; color: var(--text-primary);">ðŸš– Self Drive Cars</h3>
                    <div class="booking-list">
                        <c:choose>
                                    ...
                                    <div class="booking-item booking-card-status" data-status="${car.status.toLowerCase()}">
                                        ...
                                        <div style="text-align: right; display:flex; flex-direction:column; gap:8px;">
                                            <div>
                                                ...
                                                <span style="font-weight: 800; font-size: 1.2rem; color:var(--color-primary);">â‚¹${car.totalFare}</span>
                                            </div>
                                                                                        <div style="display:flex; gap:5px; justify-content: flex-end; margin-top:10px;">
                            ...
                            <c:otherwise>
                                <div class="empty-state" style="padding: 30px; text-align: center; border: 1px dashed var(--color-border); border-radius: 12px;">
                                    <p style="color: var(--text-secondary); font-size: 1.1rem;">ðŸš– No self-drive car bookings found</p>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
                ...
                <div class="booking-category" id="cat-cruises" style="margin-top: 40px;">
                    <h3 style="margin-bottom: 15px; color: var(--text-primary);">ðŸš¢ Cruises</h3>
                    <div class="booking-list">
                        <c:choose>
                                    ...
                                    <div class="booking-item booking-card-status" data-status="${cr.status.toLowerCase()}">
                                        ...
                                        <div style="text-align: right; display:flex; flex-direction:column; gap:8px;">
                                            <div>
                                                ...
                                                <span style="font-weight: 800; font-size: 1.2rem; color:var(--color-primary);">â‚¹${cr.totalFare}</span>
                                            </div>
                                                                                        <div style="display:flex; gap:5px; justify-content: flex-end; margin-top:10px;">
                            ...
                            <c:otherwise>
                                <div class="empty-state" style="padding: 30px; text-align: center; border: 1px dashed var(--color-border); border-radius: 12px;">
                                    <p style="color: var(--text-secondary); font-size: 1.1rem;">ðŸš¢ No cruise bookings found</p>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
                ...
                <div class="booking-category" id="cat-helicopters" style="margin-top: 40px;">
                    <h3 style="margin-bottom: 15px; color: var(--text-primary);">ðŸš Helicopters</h3>
                    <div class="booking-list">
                        <c:choose>
                                ...
                                <c:forEach var="h" items="${heliBookings}">
                                    <div class="booking-item booking-card-status" data-status="${h.status.toLowerCase()}">
                                        ...
                                        <div style="text-align: right; display:flex; flex-direction:column; gap:8px;">
                                            <div>
                                                <span class="status-pill status-${h.status.toLowerCase() == 'confirmed' ? 'completed' : h.status.toLowerCase()}" style="margin-right:10px;">${h.status}</span>
                                                <span style="font-weight: 800; font-size: 1.2rem; color:var(--color-primary);">â‚¹${h.totalFare}</span>
                                            </div>
                                                                                        <div style="display:flex; gap:5px; justify-content: flex-end; margin-top:10px;">
                            ...
                            <c:otherwise>
                                <div class="empty-state" style="padding: 30px; text-align: center; border: 1px dashed var(--color-border); border-radius: 12px;">
                                    <p style="color: var(--text-secondary); font-size: 1.1rem;">ðŸš No helicopter bookings found</p>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
        ...
        renderPosts(posts) {
            ...
            posts.forEach(post => {
                ...
                if (post.rating !== null && post.rating > 0) {
                    ratingHtml = `<div style="color: #FFD700; font-size: 0.9rem; margin-top:5px;">\${'â˜…'.repeat(post.rating)}\${'â˜†'.repeat(5 - post.rating)}</div>`;
                }
                    ...
                    <div style="flex: 1; display:flex; flex-direction:column; justify-content:space-between;">
                        <div>
                            <div style="display:flex; justify-content:space-between; align-items:flex-start;">
                                <div>
                                    ...
                                    \${post.location ? `<div style="color:var(--text-secondary); font-size:0.85rem; margin-bottom:5px;">ðŸ“ \${post.location}</div>` : ''}
                                </div>
                        ...
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-top: 15px; border-top: 1px solid var(--color-border); padding-top: 15px;">
                            <div style="display:flex; gap: 15px; color:var(--text-secondary); font-size:0.9rem;">
                                <span>â¤ï¸ \${post.likeCount} Likes</span>

...
<head>
    ...
    <script>(function(){ var t=localStorage.getItem('theme'); if(t) document.documentElement.setAttribute('data-theme',t); })(); window.CONTEXT_PATH = "${pageContext.request.contextPath}";</script>
...
<div class="login-split">
    ...
    <div class="login-form-panel">
        <div class="login-form-wrap">
            ...
            <form action="${pageContext.request.contextPath}/register" method="POST" id="registerForm" novalidate data-vx>
            ...
            <a href="${pageContext.request.contextPath}/login" class="login-back">
...
<script>
    ...
    document.getElementById('registerForm').addEventListener('submit', function (e) {
        ...
        fetch(window.CONTEXT_PATH + '/register', {
            method: 'POST',

    ...
    <div class="ticket-container" id="ticketArea">
        <div class="header">
            ...
            <div style="text-align:right;">
                ...
                <div class="ticket-title">Receipt</div>
        ...
        <div class="content-grid">
            ...
            <div class="field-group">
                ...
                <div class="value">${booking.pickup} to ${booking.dropoff}</div>
            </div>
            <div class="field-group">
                <div class="label">Distance & Duration</div>
                <div class="value">${booking.distance} | ${booking.duration}</div>
            </div>
            <div class="field-group">
                <div class="label">Fare</div>
                <div class="value">₹${booking.amount}</div>
            </div>

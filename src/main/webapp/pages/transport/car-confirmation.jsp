    ...
    <div class="container mx-auto px-4 max-w-3xl">
        ...
        <div style="background: var(--color-surface); border-radius: 12px; padding: 30px; box-shadow: 0 4px 32px rgba(0,0,0,0.28);">
            ...
            <div class="flex justify-center gap-4 mt-8">
                <a href="${pageContext.request.contextPath}/transport/car/confirmation?print=true&bookingRef=${booking.id}" target="_blank" class="px-6 py-3 text-white rounded-lg font-bold flex items-center gap-2 transition" style="background-color: #8b5cf6;">

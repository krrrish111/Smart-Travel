    ...
    <form action="${pageContext.request.contextPath}/transport/helicopter/search" method="post" class="grid grid-cols-1 md:grid-cols-5 gap-6">
        ...
        <div class="form-group relative">
            ...
            <input type="text" name="origin" placeholder="e.g. Dehradun" required 
                   class="w-full bg-gray-800 text-white rounded-lg border border-gray-600 px-4 py-3 focus:border-yellow-500 outline-none transition location-autocomplete">
        </div>
        ...
        <div class="form-group relative">
            ...
            <input type="text" name="destination" placeholder="e.g. Kedarnath" required 
                   class="w-full bg-gray-800 text-white rounded-lg border border-gray-600 px-4 py-3 focus:border-yellow-500 outline-none transition voyastra-autocomplete location-autocomplete">
        </div>

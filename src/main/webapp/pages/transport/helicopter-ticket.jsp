...
<head>
    <meta charset="UTF-8">
    <title>Flight Pass - Voyastra</title>
...
<body>
    ...
    <div class="ticket-container" id="ticketArea">
        <div class="header">
            ...
            <div style="text-align:right;">
                ...
                <div class="ticket-title">Flight Pass</div>
        ...
        <div class="content-grid">
            ...
            <div class="field-group">
                ...
                <div class="value">${booking.operator} (${booking.flightNumber})</div>
            </div>
            <div class="field-group">
                <div class="label">Route</div>
                <div class="value">${booking.source} to ${booking.destination}</div>
            </div>
            <div class="field-group">
    ...
    <script>
        function downloadPDF() {
            ...
            const opt = {
                margin:       0.5,
                filename:     'Flight_Pass_${booking.id}.pdf',

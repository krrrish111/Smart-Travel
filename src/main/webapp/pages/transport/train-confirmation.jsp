    ...
    <div class="container mx-auto px-4 max-w-3xl">
        ...
        <div style="background: var(--color-surface); border-radius: 12px; padding: 30px; box-shadow: 0 4px 32px rgba(0,0,0,0.28);">
            ...
            <div class="flex justify-center gap-4">
                <a href="${pageContext.request.contextPath}/transport/train/confirmation?print=true&bookingRef=${booking.id}" target="_blank" class="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-lg font-bold flex items-center gap-2 transition">

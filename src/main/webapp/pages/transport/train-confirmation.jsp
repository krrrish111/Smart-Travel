...
<div class="details-container">
    <div class="details-header">
        ...
        <h1 class="details-title">Train Booking Details</h1>
    ...
    <div class="details-grid">
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">${booking.trainName}</div>
        </div>
        <div class="detail-item">
            <div class="detail-label">Train Number</div>
            <div class="detail-value">${booking.trainNumber}</div>
        </div>
        <div class="detail-item">
            <div class="detail-label">PNR</div>
            <div class="detail-value">${booking.pnr}</div>
        </div>
        <div class="detail-item">
            <div class="detail-label">Coach</div>
            <div class="detail-value">${booking.coach}</div>
        </div>
        <div class="detail-item">
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">${booking.fromStation}</div>
        </div>
        <div class="detail-item">
            <div class="detail-label">Destination</div>
            <div class="detail-value">${booking.toStation}</div>
        </div>
        <div class="detail-item">
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">${booking.arrivalTime}</div>
        </div>
        <div class="detail-item">

            ...
            function renderAuthWidget() {
                ...
                if (!session) {
                    ...
                    function buildDropdown() {
                        var isAdmin = (session.email === 'admin@voyastra.com');
                        ...
                        dd.innerHTML =
                            ...
                            '</div>' +
                            adminLink +
                            '<a href="dashboard.jsp" class="nav-dropdown-item" role="menuitem">' +
                            ...
                            '<a href="planner.jsp" class="nav-dropdown-item" role="menuitem">' +
                                ...
                                'My Plans' +
                            '</a>' +
                            '<a href="booking.jsp" class="nav-dropdown-item" role="menuitem">' +

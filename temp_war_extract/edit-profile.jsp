        ...
        <div class="edit-profile-card slide-up delay-1">
            <form id="editProfileForm">
                ...
                <div class="flex justify-end gap-3 mt-6">
                    <a href="dashboard.jsp" class="btn btn-outline" style="padding: 12px 24px;">Cancel</a>
        ...
        try {
            ...
            if (sessionData) {
                ...
                if (user.profileImage) {
                    currentBase64Image = user.profileImage;
                    avatarImage.src = currentBase64Image;
                    avatarImage.style.display = 'block';
                }
            } else {
                // Not logged in -> redirect to login (basic fallback)
                window.location.href = 'login.jsp?redirect=edit-profile.jsp';
            }
        } catch(e) {

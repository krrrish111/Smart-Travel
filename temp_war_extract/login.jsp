    ...
    <div class="login-form-panel">
        <div class="login-form-wrap">
            ...
            <div class="login-hint">
                ...
                Email: <code>demo@voyastra.com</code> &nbsp;|&nbsp; Password: <code>voyastra123</code>
            </div>
            ...
            <div style="display: flex; flex-direction: column; align-items: center; gap: 12px; margin-top: 24px;">
                <a href="register.jsp" class="login-back" style="margin-top: 0;">
...
<script>
    ...
    // If already logged in (checked via backend javaSession projection), skip login and go straight to the destination
    ...
    // Standard form submission handles login now.

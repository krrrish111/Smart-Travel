...
<div id="voyastraPreloader" style="
    ...
    <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; gap:0;">
        ...
        <!-- Dynamic font text -->
        <div class="preloader-text-dynamic" style="color: #0f0b08; font-size: 1.5rem; letter-spacing: 0.2em; margin-top: 1rem; font-family: 'Inter', sans-serif; font-weight: 600;">VOYASTRA</div>
    </div>
</div>
...
<script>
    /* ── Preloader: first-visit gate ─────────────────────────────────────
       ...
       On RETURN visits → keep opacity 0, replace instantly with display none.
       On FIRST visit  → show the preloader, then hide after 3.5s minimum OR window.load.
    ──────────────────────────────────────────────────────────────────── */
    (function () {
        ...
        if (sessionStorage.getItem(KEY)) {
            /* ── Return visit: never show, hide synchronously before paint ── */
                    ...
                    <div class="hero-content parallax-bg text-center max-w-4xl mx-auto" style="position: relative; z-index: 10;" data-speed="0.05">
                        <div class="mb-3 inline-block slide-up"
                            ...
                            <span class="text-primary font-bold text-sm"
                                style="font-family: 'Poppins', sans-serif; color: var(--color-primary); letter-spacing: 0.05em; display: flex; align-items: center; gap: 6px;">
            ...
            <section class="carousel-section container scroll-fade">
                ...
                <div class="plan-scroll-outer">
                    ...
                    <div class="plan-scroll-inner" id="planScrollInner">
                        ...
                        <!-- ===== DYNAMIC SET 1 ===== -->
                        <c:forEach var="plan" items="${featuredPlans}">
                            <div class="plan-card active">
                                <div class="plan-card-img-wrap">
                                    <img src="${not empty plan.image ? plan.image : 'https://images.unsplash.com/photo-1542332213-31f87348057f?auto=format&fit=crop&w=800&q=80'}"
                                        alt="${plan.title}">
                                    <div class="plan-card-category" style="background:rgba(212,140,90,0.85);">${plan.category}</div>
                                </div>
                                <div class="plan-card-body">
                                    <div class="plan-card-location"><svg width="12" height="12" viewBox="0 0 24 24"
                                        ...
                                        </svg> <c:out value="${not empty plan.destinationName ? plan.destinationName : 'India'}"/></div>
                                    <div class="plan-card-title">${plan.title}</div>
                                    <p class="text-muted text-sm" style="display: -webkit-box; -webkit-line-clamp: 2; line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; margin-top: 8px;">
                                        ${plan.description}
                                    </p>
                                    <div class="plan-card-footer" style="margin-top: 16px;">
                                        <div class="plan-price">₹${plan.price}</div>
                                        <div class="plan-duration"><svg width="12" height="12" viewBox="0 0 24 24"
                                                fill="none" stroke="currentColor" stroke-width="2">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <polyline points="12 6 12 12 16 14"></polyline>
                                            </svg> ${plan.days} Days</div>
                                    </div>
                                    <a href="planner.jsp?location=${plan.title}" class="plan-card-view-btn">View Plan →</a>
                                </div>
                            </div>
                        </c:forEach>

                        <!-- ===== DYNAMIC SET 2 (for infinite loop) ===== -->
                        <c:forEach var="plan" items="${featuredPlans}">
                            <div class="plan-card active">
                                <div class="plan-card-img-wrap">
                                    <img src="${not empty plan.image ? plan.image : 'https://images.unsplash.com/photo-1542332213-31f87348057f?auto=format&fit=crop&w=800&q=80'}"
